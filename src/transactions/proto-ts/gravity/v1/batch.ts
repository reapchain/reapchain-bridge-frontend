...
export namespace gravity.v1 {
    export class OutgoingTxBatch extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("cosmos_block_created" in data && data.cosmos_block_created != undefined) {
                    this.cosmos_block_created = data.cosmos_block_created;
                }
            }
        }
        get batch_nonce() {
        ...
        get cosmos_block_created() {
            return pb_1.Message.getFieldWithDefault(this, 5, 0) as number;
        }
        set cosmos_block_created(value: number) {
        ...
        static fromObject(data: {
            ...
            if (data.cosmos_block_created != null) {
                message.cosmos_block_created = data.cosmos_block_created;
            }
            return message;
        }
        toObject() {
            ...
            if (this.cosmos_block_created != null) {
                data.cosmos_block_created = this.cosmos_block_created;
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.cosmos_block_created != 0)
                writer.writeUint64(5, this.cosmos_block_created);
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        message.cosmos_block_created = reader.readUint64();
                        break;
    ...
    export class OutgoingLogicCall extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.cosmos_block_created != 0)
                writer.writeUint64(8, this.cosmos_block_created);
            if (!w)
                return writer.getResultBuffer();
        }
