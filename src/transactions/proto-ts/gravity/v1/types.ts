...
export namespace gravity.v1 {
    ...
    export class PendingIbcAutoForward extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            foreign_receiver?: string;
            token?: dependency_1.cosmos.base.v1beta1.Coin;
            ibc_channel?: string;
            event_nonce?: number;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
                if ("foreign_receiver" in data && data.foreign_receiver != undefined) {
                    this.foreign_receiver = data.foreign_receiver;
                }
        ...
        get foreign_receiver() {
            return pb_1.Message.getFieldWithDefault(this, 1, "") as string;
        }
        set foreign_receiver(value: string) {
            pb_1.Message.setField(this, 1, value);
        }
        get token() {
        ...
        set token(value: dependency_1.cosmos.base.v1beta1.Coin) {
        ...
        static fromObject(data: {
            foreign_receiver?: string;
            token?: ReturnType<typeof dependency_1.cosmos.base.v1beta1.Coin.prototype.toObject>;
            ibc_channel?: string;
            event_nonce?: number;
        }): PendingIbcAutoForward {
            const message = new PendingIbcAutoForward({});
            if (data.foreign_receiver != null) {
                message.foreign_receiver = data.foreign_receiver;
            }
            if (data.token != null) {
                message.token = dependency_1.cosmos.base.v1beta1.Coin.fromObject(data.token);
            }
            if (data.ibc_channel != null) {
                message.ibc_channel = data.ibc_channel;
            }
        ...
        toObject() {
            ...
            if (this.foreign_receiver != null) {
                data.foreign_receiver = this.foreign_receiver;
            }
            if (this.token != null) {
                data.token = this.token.toObject();
            }
            if (this.ibc_channel != null) {
                data.ibc_channel = this.ibc_channel;
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.foreign_receiver.length)
                writer.writeString(1, this.foreign_receiver);
            if (this.has_token)
                writer.writeMessage(2, this.token, () => this.token.serialize(writer));
            if (this.ibc_channel.length)
                writer.writeString(3, this.ibc_channel);
            if (this.event_nonce != 0)
                writer.writeUint64(4, this.event_nonce);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PendingIbcAutoForward {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PendingIbcAutoForward();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        message.foreign_receiver = reader.readString();
                        break;
                    case 2:
                        reader.readMessage(message.token, () => message.token = dependency_1.cosmos.base.v1beta1.Coin.deserialize(reader));
                        break;
                    case 3:
                        message.ibc_channel = reader.readString();
                        break;
                    case 4:
        ...
        static deserializeBinary(bytes: Uint8Array): PendingIbcAutoForward {
            return PendingIbcAutoForward.deserialize(bytes);
        }
    }
}
