...
export namespace gravity.v1 {
    ...
    export class EventSendToCosmosPendingIbcAutoForward extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            nonce?: string;
            receiver?: string;
        ...
        static fromObject(data: {
            ...
            const message = new EventSendToCosmosPendingIbcAutoForward({});
            if (data.nonce != null) {
                message.nonce = data.nonce;
            }
            if (data.receiver != null) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): EventSendToCosmosPendingIbcAutoForward {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new EventSendToCosmosPendingIbcAutoForward();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): EventSendToCosmosPendingIbcAutoForward {
            return EventSendToCosmosPendingIbcAutoForward.deserialize(bytes);
        }
    }
    export class EventSendToCosmosExecutedIbcAutoForward extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            nonce?: string;
            receiver?: string;
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("timeout_time" in data && data.timeout_time != undefined) {
                    this.timeout_time = data.timeout_time;
                }
        ...
        set timeout_time(value: string) {
            pb_1.Message.setField(this, 6, value);
        }
        get timeout_height() {
            return pb_1.Message.getFieldWithDefault(this, 7, "") as string;
        }
        set timeout_height(value: string) {
        ...
        static fromObject(data: {
            ...
            const message = new EventSendToCosmosExecutedIbcAutoForward({});
            if (data.nonce != null) {
                message.nonce = data.nonce;
            }
            if (data.receiver != null) {
            ...
            if (data.timeout_time != null) {
                message.timeout_time = data.timeout_time;
            }
        ...
        toObject() {
            ...
            if (this.timeout_time != null) {
                data.timeout_time = this.timeout_time;
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.channel.length)
                writer.writeString(5, this.channel);
            if (this.timeout_time.length)
                writer.writeString(6, this.timeout_time);
            if (this.timeout_height.length)
                writer.writeString(7, this.timeout_height);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): EventSendToCosmosExecutedIbcAutoForward {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new EventSendToCosmosExecutedIbcAutoForward();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        message.timeout_time = reader.readString();
                        break;
                    case 7:
                        message.timeout_height = reader.readString();
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes: Uint8Array): EventSendToCosmosExecutedIbcAutoForward {
            return EventSendToCosmosExecutedIbcAutoForward.deserialize(bytes);
        }
    }
}
