...
export namespace gravity.v1 {
    ...
    export class QueryLastObservedEthBlockRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            use_v1_key?: boolean;
        }) {
            ...
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
                if ("use_v1_key" in data && data.use_v1_key != undefined) {
                    this.use_v1_key = data.use_v1_key;
                }
            }
        }
        get use_v1_key() {
        ...
        set use_v1_key(value: boolean) {
            pb_1.Message.setField(this, 1, value);
        }
        static fromObject(data: {
            use_v1_key?: boolean;
        }): QueryLastObservedEthBlockRequest {
            const message = new QueryLastObservedEthBlockRequest({});
            if (data.use_v1_key != null) {
                message.use_v1_key = data.use_v1_key;
            }
            return message;
        }
        toObject() {
            ...
            if (this.use_v1_key != null) {
                data.use_v1_key = this.use_v1_key;
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.use_v1_key != false)
                writer.writeBool(1, this.use_v1_key);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryLastObservedEthBlockRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryLastObservedEthBlockRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        message.use_v1_key = reader.readBool();
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes: Uint8Array): QueryLastObservedEthBlockRequest {
            return QueryLastObservedEthBlockRequest.deserialize(bytes);
        }
    }
    export class QueryLastObservedEthBlockResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            block?: number;
        }) {
        ...
        static fromObject(data: {
            ...
            const message = new QueryLastObservedEthBlockResponse({});
            if (data.block != null) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryLastObservedEthBlockResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryLastObservedEthBlockResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): QueryLastObservedEthBlockResponse {
            return QueryLastObservedEthBlockResponse.deserialize(bytes);
        }
    }
    export class QueryLastObservedEthNonceRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            use_v1_key?: boolean;
        }) {
        ...
        static fromObject(data: {
            ...
            const message = new QueryLastObservedEthNonceRequest({});
            if (data.use_v1_key != null) {
                message.use_v1_key = data.use_v1_key;
            }
            return message;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryLastObservedEthNonceRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryLastObservedEthNonceRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): QueryLastObservedEthNonceRequest {
            return QueryLastObservedEthNonceRequest.deserialize(bytes);
        }
    }
    export class QueryLastObservedEthNonceResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            nonce?: number;
        }) {
        ...
        static fromObject(data: {
            ...
            const message = new QueryLastObservedEthNonceResponse({});
            if (data.nonce != null) {
                message.nonce = data.nonce;
            }
            return message;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryLastObservedEthNonceResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryLastObservedEthNonceResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): QueryLastObservedEthNonceResponse {
            return QueryLastObservedEthNonceResponse.deserialize(bytes);
        }
    }
    export class QueryAttestationsRequest extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.use_v1_key != false)
                writer.writeBool(6, this.use_v1_key);
            if (!w)
                return writer.getResultBuffer();
        }
    ...
    export class QueryPendingIbcAutoForwards extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            limit?: number;
        }) {
        ...
        static fromObject(data: {
            ...
            const message = new QueryPendingIbcAutoForwards({});
            if (data.limit != null) {
                message.limit = data.limit;
            }
            return message;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryPendingIbcAutoForwards {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryPendingIbcAutoForwards();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): QueryPendingIbcAutoForwards {
            return QueryPendingIbcAutoForwards.deserialize(bytes);
        }
    }
    export class QueryPendingIbcAutoForwardsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            pending_ibc_auto_forwards?: dependency_2.gravity.v1.PendingIbcAutoForward[];
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
                if ("pending_ibc_auto_forwards" in data && data.pending_ibc_auto_forwards != undefined) {
                    this.pending_ibc_auto_forwards = data.pending_ibc_auto_forwards;
                }
            }
        }
        get pending_ibc_auto_forwards() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_2.gravity.v1.PendingIbcAutoForward, 1) as dependency_2.gravity.v1.PendingIbcAutoForward[];
        }
        set pending_ibc_auto_forwards(value: dependency_2.gravity.v1.PendingIbcAutoForward[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        static fromObject(data: {
            pending_ibc_auto_forwards?: ReturnType<typeof dependency_2.gravity.v1.PendingIbcAutoForward.prototype.toObject>[];
        }): QueryPendingIbcAutoForwardsResponse {
            const message = new QueryPendingIbcAutoForwardsResponse({});
            if (data.pending_ibc_auto_forwards != null) {
                message.pending_ibc_auto_forwards = data.pending_ibc_auto_forwards.map(item => dependency_2.gravity.v1.PendingIbcAutoForward.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.pending_ibc_auto_forwards != null) {
                data.pending_ibc_auto_forwards = this.pending_ibc_auto_forwards.map((item: dependency_2.gravity.v1.PendingIbcAutoForward) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.pending_ibc_auto_forwards.length)
                writer.writeRepeatedMessage(1, this.pending_ibc_auto_forwards, (item: dependency_2.gravity.v1.PendingIbcAutoForward) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryPendingIbcAutoForwardsResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryPendingIbcAutoForwardsResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.pending_ibc_auto_forwards, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_2.gravity.v1.PendingIbcAutoForward.deserialize(reader), dependency_2.gravity.v1.PendingIbcAutoForward));
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes: Uint8Array): QueryPendingIbcAutoForwardsResponse {
            return QueryPendingIbcAutoForwardsResponse.deserialize(bytes);
        }
    }
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            ...
            GetLastObservedEthBlock: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryLastObservedEthBlockRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryLastObservedEthBlockRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryLastObservedEthBlockResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryLastObservedEthBlockResponse.deserialize(new Uint8Array(bytes))
            },
            GetLastObservedEthNonce: {
                path: "/gravity.v1.Query/GetLastObservedEthNonce",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryLastObservedEthNonceRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryLastObservedEthNonceRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryLastObservedEthNonceResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryLastObservedEthNonceResponse.deserialize(new Uint8Array(bytes))
            },
            GetAttestations: {
            ...
            GetPendingIbcAutoForwards: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryPendingIbcAutoForwards) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryPendingIbcAutoForwards.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryPendingIbcAutoForwardsResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryPendingIbcAutoForwardsResponse.deserialize(new Uint8Array(bytes))
            }
        };
        ...
        abstract GetLastObservedEthBlock(call: grpc_1.ServerUnaryCall<QueryLastObservedEthBlockRequest, QueryLastObservedEthBlockResponse>, callback: grpc_1.sendUnaryData<QueryLastObservedEthBlockResponse>): void;
        abstract GetLastObservedEthNonce(call: grpc_1.ServerUnaryCall<QueryLastObservedEthNonceRequest, QueryLastObservedEthNonceResponse>, callback: grpc_1.sendUnaryData<QueryLastObservedEthNonceResponse>): void;
        ...
        abstract GetPendingIbcAutoForwards(call: grpc_1.ServerUnaryCall<QueryPendingIbcAutoForwards, QueryPendingIbcAutoForwardsResponse>, callback: grpc_1.sendUnaryData<QueryPendingIbcAutoForwardsResponse>): void;
    }
    export class QueryClient extends grpc_1.makeGenericClientConstructor(UnimplementedQueryService.definition, "Query", {}) {
        ...
        GetLastObservedEthBlock: GrpcUnaryServiceInterface<QueryLastObservedEthBlockRequest, QueryLastObservedEthBlockResponse> = (message: QueryLastObservedEthBlockRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryLastObservedEthBlockResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryLastObservedEthBlockResponse>, callback?: grpc_1.requestCallback<QueryLastObservedEthBlockResponse>): grpc_1.ClientUnaryCall => {
            return super.GetLastObservedEthBlock(message, metadata, options, callback);
        };
        GetLastObservedEthNonce: GrpcUnaryServiceInterface<QueryLastObservedEthNonceRequest, QueryLastObservedEthNonceResponse> = (message: QueryLastObservedEthNonceRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryLastObservedEthNonceResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryLastObservedEthNonceResponse>, callback?: grpc_1.requestCallback<QueryLastObservedEthNonceResponse>): grpc_1.ClientUnaryCall => {
            return super.GetLastObservedEthNonce(message, metadata, options, callback);
        };
        ...
        GetPendingIbcAutoForwards: GrpcUnaryServiceInterface<QueryPendingIbcAutoForwards, QueryPendingIbcAutoForwardsResponse> = (message: QueryPendingIbcAutoForwards, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryPendingIbcAutoForwardsResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryPendingIbcAutoForwardsResponse>, callback?: grpc_1.requestCallback<QueryPendingIbcAutoForwardsResponse>): grpc_1.ClientUnaryCall => {
            return super.GetPendingIbcAutoForwards(message, metadata, options, callback);
        };
    }
}
